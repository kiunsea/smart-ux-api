...
import com.smartuxapi.ai.gemini.GeminiThread;
...
public class ActionQueueServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String aiModel = req.getParameter("ai_model");
    ...
    private void OpenAIAPI(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
            ...
            if (procType != null && "dynamic".equals(procType)) {//동적으로 화면 전환
                ...
                try {
                    if (chatRoom.getMessage() != null) {
                        resJson = chatRoom.getMessage().sendPrompt((userMsg != null ? userMsg : ""));
                        log.debug("======================================================================");
    ...
    private void GeminiAPI(HttpServletRequest req, HttpServletResponse res) throws IOException {
            ...
            if (procType != null && "dynamic".equals(procType)) {//동적으로 화면 전환
                ...
                try {
                    if (usObj != null) {
                        ...
                        chatRoom = new GeminiThread(apiKey, model);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }

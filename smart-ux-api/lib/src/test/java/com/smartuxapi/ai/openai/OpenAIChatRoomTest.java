...
public class OpenAIChatRoomTest {
    ...
    public static void main(String args[]) throws Exception {
        ...
        if (crTest.chatRoom.closeThread())
            System.out.println("* [" + crTest.chatRoom.getThreadId() + "] 채팅방 삭제 완료");
    }

    public void testChat(String prompt) throws Exception {
        SmuMessages chat = this.chatRoom.getMessages();
    ...
    public void testChatAction() throws Exception {
        ...
        this.chatRoom.getMessages().sendMessage("다음의 내용을 학습해 -> " + sb);
        ...
        JSONObject resJson = this.chatRoom.getMessages().sendMessage(usrQ);

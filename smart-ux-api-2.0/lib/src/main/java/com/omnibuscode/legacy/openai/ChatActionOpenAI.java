package com.omnibuscode.legacy.openai;
...
import com.omnibuscode.legacy.ChatAction;
...
public class ChatActionOpenAI extends ChatAction {
    ...
    public ChatActionOpenAI(OpenAIAssistant assistInfo, APIConnection conn, String threadId) {
